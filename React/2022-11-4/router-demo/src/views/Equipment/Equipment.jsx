...
import EquipmentStyle from './Equipment.module.scss';
...
export default function Equipment () {
    ...
    return (
        <div className={EquipmentStyle.table}>
            <div className={EquipmentStyle.operation}>
            ...
            <Table
                ...
                pagination={false}
            />
            <div className={EquipmentStyle.page}>
                <Pagination
                    current={pageNum}
